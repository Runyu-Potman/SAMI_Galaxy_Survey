...
def plot_age_and_Z(axs_x, age_full, metal_full, r_all, age_array, metal_array, age_std_array, metal_std_array,
                   label_pad = 0.85, bar_fraction = 0.049, bar_pad = 0.02, fontsize = 12,
    ...
    axs[axs_x, 2].errorbar(
        ...
        alpha = 0.28, elinewidth = 1, capsize = 1, zorder = 1
    )
...
if __name__ == "__main__":
    ...
    # -------------------------------------------------------------------------------------
    base_dir = '7969/age_z'
    age_7969, metal_7969, age_7969_array, metal_7969_array, age_7969_std, metal_7969_std, r_all_7969 = slurm_job_combine(
        base_dir)
    ...
    plot_age_and_Z(axs_x = 3, age_full = age_230776, metal_full = metal_230776, r_all = r_all_230776, age_array = age_230776_array,
                   metal_array = metal_230776_array, age_std_array = age_230776_std, metal_std_array = metal_230776_std,
                   name = 230776, r_dash = 4.6)

    #----------------------------------------------
    base_dir = '9239900248/age_z'
    age_9239900248, metal_9239900248, age_9239900248_array, metal_9239900248_array, age_9239900248_std, metal_9239900248_std, r_all_9239900248 = slurm_job_combine(base_dir)

    plot_age_and_Z(axs_x = 5, age_full = age_9239900248, metal_full = metal_9239900248, r_all = r_all_9239900248, age_array = age_9239900248_array,
