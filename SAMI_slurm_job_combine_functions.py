...
def plot_age_and_Z(axs_x, age_full, metal_full, r_all, age_array, metal_array, age_std_array, metal_std_array,
    ...
    if title:
        # set titles.
        axs[axs_x, 3].set_title('Stellar Metallicity Radial Profile', fontsize = fontsize)
...
#-------------------------------------------------------------------------------------
base_dir = '7969/age_z'
age_7969, metal_7969, age_7969_array, metal_7969_array, age_7969_std, metal_7969_std, r_all_7969 = slurm_job_combine(base_dir)

plot_age_and_Z(axs_x = 0, age_full = age_7969, metal_full = metal_7969, r_all = r_all_7969, age_array = age_7969_array,
               metal_array = metal_7969_array, name = 7969, title = True, r_dash = 2.65,
               vmin_age = 6, vmax_age = 12, vmin_z = -0.12, vmax_z = 0.17)
...
plot_age_and_Z(axs_x = 2, age_full = age_227266, metal_full = metal_227266, r_all = r_all_227266, age_array = age_227266_array,
               metal_array = metal_227266_array, name = 227266, r_dash = 3.85)
...
#----------------------------------------------
base_dir = '9239900248/age_z'
age_9239900248, metal_9239900248, age_9239900248_array, metal_9239900248_array, r_all_9239900248 = slurm_job_combine(base_dir)

plot_age_and_Z(axs_x = 4, age_full = age_9239900248, metal_full = metal_9239900248, r_all = r_all_9239900248, age_array = age_9239900248_array,
               metal_array = metal_9239900248_array, name = 9239900248, r_dash = 3.55,
               vmin_age = 4, vmax_age = 11, vmin_z = -0.56)
