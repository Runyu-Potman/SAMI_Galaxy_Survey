...
vel_map = pd.read_csv('stellar_velocity_quality_cut_230776.csv')
...
core_dataframe.to_csv('stellar_velocity_quality_cut_core_region_230776.csv', index = False)
outskirts_dataframe.to_csv('stellar_velocity_quality_cut_outskirts_region_230776.csv', index = False)

# read the csv file of core region.
vel_map_core = pd.read_csv('stellar_velocity_quality_cut_core_region_230776.csv')
...
vel_map_outskirts = pd.read_csv('stellar_velocity_quality_cut_outskirts_region_230776.csv')
