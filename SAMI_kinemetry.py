...
def pa_and_k1_plot(k, axs, ypa_lim, ypa_tick, yk1_lim, yk1_tick, x_lim, x_tick,
    ...
    axs[0].set_ylabel(r'$\mathrm{PA}_\bigstar$ (degrees)', fontsize = 12, labelpad = label_pad)
...
#-----------------------------------------------------------------
fig, axs = plt.subplots(2, 6, figsize = (20, 5), gridspec_kw = {'hspace': 0, 'wspace': 0.35})
#---------------------------------------------------------------
# 7969.
...
k_7969 = kinemetry(xbin = xbin, ybin = ybin, moment = velbin, error = er_velbin, x0 = np.median(xbin), y0 = np.median(ybin), rangeQ = [0.8, 1],
                   rangePA = [130, 150], npa = 41, nq = 41, plot = False, scale = 1, ring = 0.2, cover = 0.5)
...
print('143287 pa:', np.mean(k_143287.pa[:4]), np.mean(k_143287_extra.pa[-6:]))

axs[0, 1].set_title('Galaxy 143287', fontsize = 12)
#------------------------------------------------------------------------------------------------------------------
# 227266.
...
print('227266 pa:', np.mean(k_227266.pa[:5]), np.mean(k_227266.pa[-6:]))

axs[0, 2].set_title('Galaxy 227266', fontsize = 12)
...
pa_and_k1_plot(k_300787, axs = axs[:, 4], ypa_lim = [-90, 180], ypa_tick = (-90, 185, 45), yk1_lim = [0, 120], yk1_tick = (0, 120, 20),
