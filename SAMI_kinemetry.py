...
pa_and_k1_plot(k_227266, axs = axs[:, 2], ypa_lim = [0, 200], ypa_tick = (0, 205, 50), yk1_lim = [0, 30], yk1_tick = (0, 30, 5),
               x_lim = [0, 7.5], x_tick = (0, 7.5, 1), pa1 = 170.54, pa2 = 32.43, pa1_err = 11.58, pa2_err = 5.28)
