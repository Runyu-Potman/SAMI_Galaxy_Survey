...
if __name__ == '__main__':
    ...
    plot_vel_or_sig(csv_path = star_output_file_143287, value_type = 'sig', ax = axs[1, 2], cmap = sig_cmap_143287, cbar_label = r'$\sigma_{\bigstar}$ (km/s)', plot_psf = True, fontsize = 12, psffwhm = 2.250, vmin = 60, vmax = 180)
    #--------------------------------------------------------------------------------------------
    # 227266 optical.
    ...
    plot_vel_or_sig(csv_path = star_output_file_9239900248, value_type = 'vel', ax = axs[2, 4], cmap = vel_cmap_9239900248, cbar_label = r'$V_{\bigstar}$ (km/s)', plot_psf = True, fontsize = 12, psffwhm = 2.118, vmin = -200, vmax = 200)
    plot_vel_or_sig(csv_path = star_output_file_9239900248, value_type = 'sig', ax = axs[2, 5], cmap = sig_cmap_9239900248, cbar_label = r'$\sigma_{\bigstar}$ (km/s)', plot_psf = True, fontsize = 12, psffwhm = 2.118, vmin = 45, vmax = 205)
    #---------------------------------------------------------------------------------------------
    # same axis ratio.
