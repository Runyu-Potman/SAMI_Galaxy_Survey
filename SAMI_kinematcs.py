...
if __name__ == '__main__':
    ...
    # 143287 kinematics.
    plot_vel_or_sig(csv_path = star_output_file_143287, value_type = 'vel', ax = axs[1, 1], cmap = vel_cmap_143287, cbar_label = 'Velocity (km/s)', plot_psf = True, fontsize = 10, psffwhm = 2.250, vmin = -85, vmax = 85)
    plot_vel_or_sig(csv_path = star_output_file_143287, value_type = 'sig', ax = axs[1, 2], cmap = sig_cmap_143287, cbar_label = 'Velocity Dispersion (km/s)', plot_psf = True, fontsize = 10, psffwhm = 2.250, vmin = 55, vmax = 185)
    #--------------------------------------------------------------------------------------------
    # 227266 optical.
    ...
    plot_vel_or_sig(csv_path = star_output_file_227266, value_type = 'sig', ax = axs[2, 2], cmap = sig_cmap, cbar_label = 'Velocity Dispersion (km/s)', plot_psf = True, fontsize = 10, psffwhm = 2.108, vmin = 110, vmax = 230)
    # ------------------------------------------------------------------------------------------
    # 230776 optical.
    ...
    plot_vel_or_sig(csv_path = star_output_file_230776, value_type = 'sig', ax = axs[0, 5], cmap = sig_cmap, cbar_label = 'Velocity Dispersion (km/s)', plot_psf = True, fontsize = 10, psffwhm = 2.144, vmin = 270, vmax = 350)
