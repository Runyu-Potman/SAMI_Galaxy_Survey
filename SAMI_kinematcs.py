...
if __name__ == '__main__':
    ...
    # 7969 kinematics.
    plot_vel_or_sig(csv_path = star_output_file_7969, value_type = 'vel', ax = axs[0, 1], cmap = vel_cmap_7969, cbar_label= r'$V_{\bigstar}$ (km s$^{-1}$)', plot_psf = True, fontsize = 12, psffwhm = 1.561, vmin = -80, vmax = 80)
    plot_vel_or_sig(csv_path = star_output_file_7969, value_type = 'sig', ax = axs[0, 2], cmap = sig_cmap, cbar_label = r'$\sigma_{\bigstar}$ (km s$^{-1}$)', plot_psf = True, fontsize = 12, psffwhm = 1.561, vmin = 145, vmax = 305)
    ...
    # 143287 kinematics.
    plot_vel_or_sig(csv_path = star_output_file_143287, value_type = 'vel', ax = axs[1, 1], cmap = vel_cmap_143287, cbar_label = r'$V_{\bigstar}$ (km s$^{-1}$)', plot_psf = True, fontsize = 12, psffwhm = 2.250)
    plot_vel_or_sig(csv_path = star_output_file_143287, value_type = 'sig', ax = axs[1, 2], cmap = sig_cmap_143287, cbar_label = r'$\sigma_{\bigstar}$ (km s$^{-1}$)', plot_psf = True, fontsize = 12, psffwhm = 2.250, vmin = 60, vmax = 180)
    #--------------------------------------------------------------------------------------------
    # 227266 optical.
    ...
    # 227266 kinematics.
    plot_vel_or_sig(csv_path = star_output_file_227266, value_type = 'vel', ax = axs[2, 1], cmap = vel_cmap, cbar_label = r'$V_{\bigstar}$ (km s$^{-1}$)', plot_psf = True, fontsize = 12, psffwhm = 2.108, vmin = -55, vmax = 55)
    plot_vel_or_sig(csv_path = star_output_file_227266, value_type = 'sig', ax = axs[2, 2], cmap = sig_cmap, cbar_label = r'$\sigma_{\bigstar}$ (km s$^{-1}$)', plot_psf = True, fontsize = 12, psffwhm = 2.108, vmin = 110, vmax = 230)
    # ------------------------------------------------------------------------------------------
    # 230776 optical.
