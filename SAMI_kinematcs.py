...
if __name__ == '__main__':
    ...
    # 227266 kinematics.
    plot_vel_or_sig(csv_path = star_output_file_227266, value_type = 'vel', ax = axs[0, 4], cmap = vel_cmap, cbar_label = 'Velocity (km/s)', plot_psf = True, fontsize = 10, psffwhm = 2.108, vmin = -55, vmax = 55)
    plot_vel_or_sig(csv_path = star_output_file_227266, value_type = 'sig', ax = axs[0, 5], cmap = sig_cmap, cbar_label = 'Velocity Dispersion (km/s)', plot_psf = True, fontsize = 10, psffwhm = 2.108, vmin = 110, vmax = 230)
    ...
    axs[1, 3].imshow(optical_230776)
    axs[1, 3].set_ylabel('Galaxy 230776', fontsize = 10, labelpad = 0.85)
    add_circle(axs[1, 3], optical_230776, linewidth = 1, label = True, E_bar = 6.5)

    # 230776 kinematics.
    plot_vel_or_sig(csv_path = star_output_file_230776, value_type = 'vel', ax = axs[1, 4], cmap = vel_cmap_230776, cbar_label = 'Velocity (km/s)', plot_psf = True, fontsize = 10, psffwhm = 2.144, vmin = -35, vmax = 35)
    plot_vel_or_sig(csv_path = star_output_file_230776, value_type = 'sig', ax = axs[1, 5], cmap = sig_cmap, cbar_label = 'Velocity Dispersion (km/s)', plot_psf = True, fontsize = 10, psffwhm = 2.144, vmin = 270, vmax = 350)
    # --------------------------------------------------------------------------------------------
    # 9239900248 optical.
