...
if __name__ == '__main__':
    ...
    plot_vel_or_sig(csv_path = star_output_file_9239900248, value_type = 'sig', ax = axs[2, 5], cmap = sig_cmap_9239900248, cbar_label = r'$\sigma_{\bigstar}$ (km s$^{-1}$)', plot_psf = True, fontsize = 12, psffwhm = 2.118, vmin = 45, vmax = 205)
    #---------------------------------------------------------------------------------------------
    # same axis ratio.
