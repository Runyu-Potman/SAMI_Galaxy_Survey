...
if __name__ == '__main__':
    ...
    # 230776 kinematics.
    plot_vel_or_sig(csv_path = star_output_file_230776, value_type = 'vel', ax = axs[0, 4], cmap = vel_cmap_230776, cbar_label = r'$V_{\bigstar}$ (km/s)', plot_psf = True, fontsize = 12, psffwhm = 2.144, vmin = -35, vmax = 35)
    plot_vel_or_sig(csv_path = star_output_file_230776, value_type = 'sig', ax = axs[0, 5], cmap = sig_cmap, cbar_label = r'$\sigma_{\bigstar}$ (km/s)', plot_psf = True, fontsize = 12, psffwhm = 2.144, vmin = 270, vmax = 350)
