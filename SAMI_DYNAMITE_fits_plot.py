...
def plot_kinematic_maps_from_fits_grid(fits_paths, number_gh = 4, labels = None,
                                       figsize = (25, 20), compass_pads_list = None):
    '''
    ...
    def add_cbar(im, ax, bottom_label, top_label):
        cb = fig.colorbar(im, ax = ax, pad = 0, fraction = 0.1667, aspect = 5)
        cb.set_ticks([])
    ...
    def draw_block(fits_path, block_spec, block_label, add_row_labels = False, compass_pads = None):
        '''
        ...
        with fits.open(fits_path) as hdul:
            ...
            add_NE_compass(ax, xc = -6.5, yc = 6.5, pa_deg = angle_deg,
                           length = 2.5, fontsize = 10,
...
if __name__ == '__main__':
    ...
    labels = [r'Galaxy 7969 ($\chi^2$/DOF = 1.02)', 'Galaxy 230776 ($\chi^2$/DOF = 1.93)', 'Galaxy 143287 ($\chi^2$/DOF = 0.91)', 'Galaxy 300787 ($\chi^2$/DOF = 1.37)', 'Galaxy 227266 ($\chi^2$/DOF = 1.66)', 'Galaxy 9239900248 ($\chi^2$/DOF = 1.14)']
