...
def correct_lambda_R(lambda_R_obs, Re_arcsec, ellipticity, sersic_n, fwhm=2.1):
    ...
    print('transferred effective radius:', Re_arcsec)
...
print('intrinsic lambda value:', lambda_7969, lambda_143287, lambda_227266, lambda_230776, lambda_300787, lambda_9239900248)
