...
def bpt(
    ...
    # plot two boundaries.
    axs[1, 0].plot(boundary_1_range, boundary_1_values, color = 'red', linestyle = '-', linewidth = 1, label = 'Ke01')
    axs[1, 0].plot(boundary_2_range, boundary_2_values, color = 'blue', linestyle = '--', linewidth = 1, label = 'Ka03')
