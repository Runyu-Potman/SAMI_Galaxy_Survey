...
def bpt(
    ...
    axs[1, 0].text(-0.8, -0.8, 'SF', color = 'grey', fontsize = 10, ha = 'center')
    axs[1, 0].text(0.0, -1, 'Comp', color = 'salmon', rotation = 90, fontsize = 10, ha = 'center')
    ...
    axs[1, 1].text(-0.4, 0.8, 'AGN', color = 'purple', fontsize = 10, ha = 'center')
