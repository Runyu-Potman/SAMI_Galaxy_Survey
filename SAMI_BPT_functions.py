...
def bpt(
    ...
    axs[1, 1].text(0.3, -0.8, 'LINERs', color = 'lightblue', fontsize = fontsize, ha = 'center')
    ...
    cbar.ax.text(1.6, 1.5, 'LINERs', va = 'center', ha = 'left', rotation = 90, fontsize = fontsize, color = 'black')
