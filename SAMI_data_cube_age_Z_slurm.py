...
def ppxf_age_z(specNew, goodpixels_nan, ln_lam, noise_value, redshift, filename, velscale, start,
               ...
               buffer=None, plot=False, pixel_coords = None, fwhm_blue = 2.65):
    '''
...
if __name__ == '__main__':
    ...
    for y in range(start_y, end_y):
        for x in range(50):
            ...
            # extract the spectrum at each spatial location.
            ...
            try:
                ...
                age_std_part[y - start_y, x] = age_std
    ...
    print(f'Finished job {job_id}, saved rows {start_y}-{end_y - 1}')
    # ------------------------------------------------------------------------------------